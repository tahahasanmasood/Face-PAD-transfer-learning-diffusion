...
concatenated_train_dataset_RM_RAR = ConcatDataset([train_dataset_real_RM, train_dataset_attack_RM, train_dataset_attack_fixed_RA, train_dataset_attack_hand_RA])
concatenated_val_dataset_RM_RAR = ConcatDataset([val_dataset_real_RM, val_dataset_attack_RM, val_dataset_attack_fixed_RA, val_dataset_attack_hand_RA])
...
for epoch in range(epochs):
    ...
    if val_total_loss < best_loss:
        ...
        torch.save(model.state_dict(), 'RM_RAA_best_model.pth')
