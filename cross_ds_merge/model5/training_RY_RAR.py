...
concatenated_train_dataset_RY_RAR = ConcatDataset([train_dataset_real_RY, train_dataset_attack_RY, train_dataset_attack_fixed_RA, train_dataset_attack_hand_RA])
concatenated_val_dataset_RY_RAR = ConcatDataset([val_dataset_real_RY, val_dataset_attack_RY, val_dataset_attack_fixed_RA, val_dataset_attack_hand_RA])

concatenated_train_loader = DataLoader(concatenated_train_dataset_RY_RAR, batch_size=64, shuffle=True, pin_memory=True, num_workers=8)
concatenated_val_loader = DataLoader(concatenated_val_dataset_RY_RAR, batch_size=64, shuffle=False, pin_memory=True, num_workers=8)

# Print dataset sizes
print(f"Training set size: {len(concatenated_train_dataset_RY_RAR)}")
print(f"Validation set size: {len(concatenated_val_dataset_RY_RAR)}")
...
for epoch in range(epochs):
    ...
    if val_total_loss < best_loss:
        ...
        torch.save(model.state_dict(), 'RY_RAA_best_model.pth')
