...
concatenated_train_dataset_RA_RMR = ConcatDataset([train_dataset_real_RA, train_dataset_attack_fixed_RA, train_dataset_attack_hand_RA, train_dataset_real_RM, train_dataset_real_RY])
concatenated_val_dataset_RA_RMR = ConcatDataset([val_dataset_real_RA, val_dataset_attack_fixed_RA, val_dataset_attack_hand_RA, val_dataset_real_RM, val_dataset_real_RY])
...
for epoch in range(epochs):
    ...
    if val_total_loss < best_loss:
        ...
        torch.save(model.state_dict(), 'RA_RMR_RYR_best_model.pth')
