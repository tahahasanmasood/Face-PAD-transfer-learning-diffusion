...
data_path_train_attack_RY = '/home/taha/FASdatasets/Sohail/Rose_Youtu/train/attack'

data_path_devel_real_RY = '/home/taha/FASdatasets/Sohail/Rose_Youtu/devel/real'
data_path_devel_attack_RY = '/home/taha/FASdatasets/Sohail/Rose_Youtu/devel/attack'
...
# Replay Mobile Real/Attack
data_path_train_real_RM =  '/home/taha/FASdatasets/Sohail/Replay-Mobile/train/real' # '/home/taha/FASdatasets/Sohail/Replay-Mobile/train/attack'
data_path_devel_real_RM =  '/home/taha/FASdatasets/Sohail/Replay-Mobile/devel/real' # '/home/taha/FASdatasets/Sohail/Replay-Mobile/devel/attack'
...
train_dataset_attack_RY = VideoDataset(data_path_train_attack_RY, class_label_attack)

val_dataset_real_RY = VideoDataset(data_path_devel_real_RY, class_label_real)
val_dataset_attack_RY = VideoDataset(data_path_devel_attack_RY, class_label_attack)
...
# Rose Youtu DataLoader
train_loader_real_RY = DataLoader(train_dataset_real_RY, batch_size=1, shuffle=True)
train_loader_attack_RY = DataLoader(train_dataset_attack_RY, batch_size=1, shuffle=True)

val_loader_real_RY = DataLoader(val_dataset_real_RY, batch_size=1, shuffle=False)
val_loader_attack_RY = DataLoader(val_dataset_attack_RY, batch_size=1, shuffle=False)

# Replay Attack (Real) DataLoader
...
concatenated_train_dataset_RY_RAR_RMR = ConcatDataset([train_dataset_real_RY, train_dataset_attack_RY, train_dataset_real_RA, train_dataset_real_RM])
concatenated_val_dataset_RY_RAR_RMR = ConcatDataset([val_dataset_real_RY, val_dataset_attack_RY, val_dataset_real_RA, val_dataset_real_RM])

concatenated_train_loader = DataLoader(concatenated_train_dataset_RY_RAR_RMR, batch_size=64, shuffle=True, pin_memory=True, num_workers=8)
concatenated_val_loader = DataLoader(concatenated_val_dataset_RY_RAR_RMR, batch_size=64, shuffle=False, pin_memory=True, num_workers=8)

# Print dataset sizes
print(f"Training set size: {len(concatenated_train_dataset_RY_RAR_RMR)}")
print(f"Validation set size: {len(concatenated_val_dataset_RY_RAR_RMR)}")
...
for epoch in range(epochs):
    ...
    if val_total_loss < best_loss:
        ...
        torch.save(model.state_dict(), 'RY_RAR_RMR_best_model.pth')
