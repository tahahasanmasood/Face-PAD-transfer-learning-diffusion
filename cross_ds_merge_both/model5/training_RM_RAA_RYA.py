...
# Rose Youtu Attack
data_path_train_real_RY = '/home/taha/FASdatasets/Sohail/Rose_Youtu/train/attack'
data_path_devel_real_RY = '/home/taha/FASdatasets/Sohail/Rose_Youtu/devel/attack'
...
# Concatenate Replay Attack + Rose Youtu (Real) Dataset

concatenated_train_dataset_RM_RAR_RYR = ConcatDataset([train_dataset_real_RM, train_dataset_attack_RM, train_dataset_attack_fixed_RA, train_dataset_attack_hand_RA, train_dataset_real_RY])
concatenated_val_dataset_RM_RAR_RYR = ConcatDataset([val_dataset_real_RM, val_dataset_attack_RM, val_dataset_attack_fixed_RA, val_dataset_attack_hand_RA, val_dataset_real_RY])

concatenated_train_loader = DataLoader(concatenated_train_dataset_RM_RAR_RYR, batch_size=64, shuffle=True, pin_memory=True, num_workers=8)
concatenated_val_loader = DataLoader(concatenated_val_dataset_RM_RAR_RYR, batch_size=64, shuffle=False, pin_memory=True, num_workers=8)

# Print dataset sizes
print(f"Training set size: {len(concatenated_train_dataset_RM_RAR_RYR)}")
print(f"Validation set size: {len(concatenated_val_dataset_RM_RAR_RYR)}")
...
for epoch in range(epochs):
    ...
    if val_total_loss < best_loss:
        ...
        torch.save(model.state_dict(), 'RM_RAA_RYA_best_model.pth')
