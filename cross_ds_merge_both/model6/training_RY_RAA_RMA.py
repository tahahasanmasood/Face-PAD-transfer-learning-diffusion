...
data_path_train_real_RM =  '/home/taha/FASdatasets/Sohail/Replay-Mobile/train/attack'
data_path_devel_real_RM =  '/home/taha/FASdatasets/Sohail/Replay-Mobile/devel/attack'
...
# Replay Attack DataLoader (Attack)
...
concatenated_train_dataset_RY_RAA_RMA = ConcatDataset([train_dataset_real_RY, train_dataset_attack_RY, train_dataset_attack_fixed_RA, train_dataset_attack_hand_RA, train_dataset_real_RM])
concatenated_val_dataset_RY_RAA_RMA = ConcatDataset([val_dataset_real_RY, val_dataset_attack_RY, val_dataset_attack_fixed_RA, val_dataset_attack_hand_RA, val_dataset_real_RM])

concatenated_train_loader = DataLoader(concatenated_train_dataset_RY_RAA_RMA, batch_size=64, shuffle=True, pin_memory=True, num_workers=8)
concatenated_val_loader = DataLoader(concatenated_val_dataset_RY_RAA_RMA, batch_size=64, shuffle=False, pin_memory=True, num_workers=8)

# Print dataset sizes
print(f"Training set size: {len(concatenated_train_dataset_RY_RAA_RMA)}")
print(f"Validation set size: {len(concatenated_val_dataset_RY_RAA_RMA)}")
...
for epoch in range(epochs):
    ...
    if val_total_loss < best_loss:
        ...
        torch.save(model.state_dict(), 'RY_RAA_RMA_best_model.pth')
