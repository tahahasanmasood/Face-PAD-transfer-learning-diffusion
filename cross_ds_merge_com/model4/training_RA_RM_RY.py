...
# Concatenate Replay Attack + Replay Mobile + Rose Youtu Dataset

concatenated_train_dataset_RA_RM_RY = ConcatDataset([train_dataset_real_RA, train_dataset_attack_fixed_RA, train_dataset_attack_hand_RA, train_dataset_real_RM, train_dataset_attack_RM, train_dataset_real_RY, train_dataset_attack_RY])
concatenated_val_dataset_RA_RM_RY = ConcatDataset([val_dataset_real_RA, val_dataset_attack_fixed_RA, val_dataset_attack_hand_RA, val_dataset_real_RM, val_dataset_attack_RM, val_dataset_real_RY, val_dataset_attack_RY])

concatenated_train_loader = DataLoader(concatenated_train_dataset_RA_RM_RY, batch_size=64, shuffle=True, pin_memory=True, num_workers=8)
concatenated_val_loader = DataLoader(concatenated_val_dataset_RA_RM_RY, batch_size=64, shuffle=False, pin_memory=True, num_workers=8)

# Print dataset sizes
print(f"Training set size: {len(concatenated_train_dataset_RA_RM_RY)}")
print(f"Validation set size: {len(concatenated_val_dataset_RA_RM_RY)}")
...
for epoch in range(epochs):
    ...
    if val_total_loss < best_loss:
        ...
        torch.save(model.state_dict(), 'RA_RM_RY_best_model.pth')
